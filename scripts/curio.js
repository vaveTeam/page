...
let curio2 = new Array('Our bot has been verified as one of the first bots in Poland', 'Once our site wasn\'t very pretty', 'It wasn\'t until we had 200 servers that we introduced our own prefix', 'Our bot is the first bot in the world to have voice commands');
let ranType2 = Math.floor(Math.random() * curio2.length);
document.getElementById('curio').innerText = curio2[ranType2];
