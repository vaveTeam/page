...
function getNotify() {
    ...
    if (!notifications_home) {console.log('%c[-] notifications_home doesn\'t exist', 'color: #fc2d2d')} else { notifications_home.innerHTML = '<div class="notification --normal" id="notcol1"><h1>To new release: <strong id="countdown">loading...</strong></h1></div><div class="bottom"></div>'; console.log('%c[+] notifications_home loaded successful!', 'color: #00ff00') }
